...
import com.josephadogeri.contact_management_app.dto.request.ContactUpdateRequestDTO;
import com.josephadogeri.contact_management_app.dto.response.ContactDeleteAllResponseDTO;
import com.josephadogeri.contact_management_app.dto.response.ContactDeleteSingleResponseDTO;
...
public class ContactController extends Auditable {
    ...
    public ContactDeleteSingleResponseDTO deleteContact(@PathVariable Integer id) {
        if(!(id instanceof Integer) ){
            throw new IllegalArgumentException(" value must be an integer");
        }
